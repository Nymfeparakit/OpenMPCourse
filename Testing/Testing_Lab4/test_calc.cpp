...
void Test_Calc::divide_SecondArgIsZero_ThrowsInvalidArgException()
{
    Calc calc;
    double a = 1;
    double b = 0;
...
void Test_Calc::takeArguments_FirstArgIsNotNumber_setErrorMsg()
{
    //Arrange
...
void Test_Calc::takeArguments_SecondArgIsNotNumber_setErrorMsg()
{
    //Arrange
    CalcViewMock calcViewMock;
...
void Test_Calc::takeArguments_FirstArgIsOutOfRange_setErrorMsg_data()
{
...
void Test_Calc::takeArguments_FirstArgIsOutOfRange_setErrorMsg()
{
    //Arrange
...
void Test_Calc::takeArguments_SecondArgIsOutOfRange_setErrorMsg_data()
{
    QTest::addColumn<QString>("firstArg");
    QTest::addColumn<QString>("secondArg");
...
void Test_Calc::takeArguments_SecondArgIsOutOfRange_setErrorMsg()
{
    //Arrange
    QFETCH(QString, firstArg);
    QFETCH(QString, secondArg);
...
void Test_Calc::takeArguments_FirstArgIsEmpty_setErrorMsg()
{
    //Arrange
    CalcViewMock calcViewMock;
...
void Test_Calc::takeArguments_SecondArgIsEmpty_setErrorMsg()
{
    //Arrange
    CalcViewMock calcViewMock;
    calcViewMock.firstArg = "2";
...
void Test_Calc::takeArguments_FirstArgUsesSciNotation_ParseArgCorrectly()
{
    //Arrange
    CalcViewMock calcViewMock;
...
void Test_Calc::takeArguments_SecondArgUsesSciNotation_ParseArgCorrectly()
{
    //Arrange
    CalcViewMock calcViewMock;
...
void Test_Calc::onPlusClicked_NumberArgs_SetCorrectOpResult_data()
{
    QTest::addColumn<QString>("firstArg");
    QTest::addColumn<QString>("secondArg");
...
void Test_Calc::onPlusClicked_NumberArgs_SetCorrectOpResult()
{
    //Arrange
    QFETCH(QString, firstArg);
    QFETCH(QString, secondArg);
...
void Test_Calc::onMinusClicked_NumberArgs_SetCorrectOpResult_data()
{
    QTest::addColumn<QString>("firstArg");
    QTest::addColumn<QString>("secondArg");
    QTest::addColumn<double>("result");
...
void Test_Calc::onMinusClicked_NumberArgs_SetCorrectOpResult()
{
    //Arrange
    QFETCH(QString, firstArg);
    QFETCH(QString, secondArg);
...
void Test_Calc::onMultiplyClicked_NumberArgs_SetCorrectOpResult_data()
{
    QTest::addColumn<QString>("firstArg");
    QTest::addColumn<QString>("secondArg");
    QTest::addColumn<double>("result");
...
void Test_Calc::onMultiplyClicked_NumberArgs_SetCorrectOpResult()
{
    //Arrange
    QFETCH(QString, firstArg);
    QFETCH(QString, secondArg);
...
void Test_Calc::onDivideClicked_NumberArgs_SetCorrectOpResult_data()
{
    QTest::addColumn<QString>("firstArg");
    QTest::addColumn<QString>("secondArg");
    QTest::addColumn<double>("result");
...
void Test_Calc::onDivideClicked_NumberArgs_SetCorrectOpResult()
{
    //Arrange
    QFETCH(QString, firstArg);
    QFETCH(QString, secondArg);
...
void Test_Calc::takeArguments_FirstArgUsesCommaAsSeparator_setErrorMsg()
{
    //Arrange
    CalcViewMock calcViewMock;
...
void Test_Calc::takeArguments_SecondArgUsesCommaAsSeparator_setErrorMsg()
{
    //Arrange
    CalcViewMock calcViewMock;
